...
<head>
	...
	<style type="text/css">
		*{margin: 0;padding: 0;}
		body{background: black;text-align: center;margin: 0 auto;}
		.content{margin: auto;}
		.content>p{text-align: justify;margin: 20px;}
		r{color: red;}
...
<body>
	<div class="content">
		...
		Thank's for choosing our lab to learn sql injection. It's a great time to learn Web Security for you. SQL injection is a first step to learn for web penatration testing. So with sql injection every hacker's known about web most common and basic problem's and vulnerability. I suggest that to everyone, please fisrt learn about php and database system and after try to do this. And make  sure php v5.6 is running on server for avoiding unexpected errors. If you start trying to do now, Please At first read about us and Disclaimers (Click About button). <br>
		 </p><br>
