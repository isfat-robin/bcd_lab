...
if (isset($_POST['result'])) {
	if (!empty($_POST['name']) or !empty($_POST['pass'])) {
		...
		if ($frm_data) {
			$frm_result = "<p style='color: #00ff00;'> &check; Logged In &#9763; <br> Hello <strong style='color: yellow;''>".$frm_data['name']."After SQL If you get password Please Crack, and submit on result box bellow.";
		}else{
...
<div class="data">
    <h3>Post SQL Injection [Blind SQL]</h3>
