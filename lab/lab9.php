...
if (isset($_GET['id']) && !empty($_GET['id'])) {
	...
	if($data && !empty($data)){
		echo "<h2>Blind SQL Injection [Single Qoutes]</h2><div class='data'><p>You are accepted in this page.<br> Now you have to chance to Do <strong> Blind SQL Here<strong> with Single Qoutes
			</p></div>";
	}else{
